...
public class MasterPanel {
    ...
    public MasterPanel () throws IOException, FontFormatException {
        ...
        //TODO: Crear clase de " Utilitis " nombre por definir donde pondremos las tipografias y llamaarla aqui

        enterName.setFont(
                Font.createFont(Font.TRUETYPE_FONT, new File("src/fonts/BebasNeue-Regular.ttf"))); // Añadimos
        // fuente
